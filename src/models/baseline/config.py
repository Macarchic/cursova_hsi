...
CONFIGS = {
    ...
    'HC':   Config(dataset='HC',   patch_size=30, pca_components=135, kernel_size=19, num_classes=16, batch_size=20),
    'LK':   Config(dataset='LK',   patch_size=30, pca_components=135, kernel_size=19, num_classes=9,  batch_size=20),
}
